...
namespace Minesweeper
{
    class Game
    {
        ...
        private void Play(int oblast_id)
        {
            ...
            {
                Console.WriteLine("Game over, You win!!! List of won games: ");
                List<HRA> wonGames = DBHelper.wonGames();
                foreach (HRA hra in wonGames)
                {
            ...
            {
                Console.WriteLine("Wrongly marked mines:");
                List<POLE> wrongMines = DBHelper.falselyMarkedMines(oblast_id);
                foreach(POLE p in wrongMines)
                {
                    Console.WriteLine(p.ToString());
                }
                Console.WriteLine("Game over, You lose!!! List of lost games: ");
                List<HRA> lostGames = DBHelper.lostGames();
                foreach (HRA hra in lostGames)
                {
                    Console.WriteLine(hra.ToString());
                }
